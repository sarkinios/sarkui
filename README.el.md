...
σε γραφικό περιβάλλον all-in-one για**πολλαπλούς**αρχεία πολυμέσων**ΤΑΥΤΟΧΡΟΝΑ**.
...
\|-[κάλτσες](https://sourceforge.net/projects/sox/files/sox/)|δοκιμασμένο με την τελευταία έκδοση| πακέτο sox|
...
2.  Μετά το βήμα 1 μπορείτε:
    ...
    -   Από**Διάφορα**Αυτί:
        -   Αλλάξτε το ρυθμό, την ταχύτητα ή μετατρέψτε τα αρχεία ήχου που επιλέγετε στο βήμα 1
