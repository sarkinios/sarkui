...
namespace Sarkui
{
    ...
    */
        ...
        private void minfo_Load_1(object sender, System.EventArgs e)
        {

            richTextBox2.AppendText(" [ Audio Streams ]\n");
            //richTextBox2.AppendText("\n");

            richTextBox2.Find("[ Audio Streams ]"); //Find the text provided
