...
namespace Sarkui
{
    // The base class for Sarkui-triggered exceptions
    public class SarkuiException : Exception
    {
        public SarkuiException(string message) : base(message) { }

        public SarkuiException(Exception inner) : base(inner.Message, inner) { }

        public SarkuiException(string message, Exception inner) : base(message, inner) { }

    }

    public class JobRunException : SarkuiException
    {
